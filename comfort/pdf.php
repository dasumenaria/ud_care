		...
		$value1=1000;       
			  ...
			  if(array_key_exists("$highno",$words))
			  {
				...
				//return $this->response;
				 ...
				 $words=$words["$ten"]." ".$words["$unit"]." ".$novalue." ".convert_number_to_words($remainno);
			   }
			}
                ...
                <th colspan="2"><b>'.$main_amnt.'</b></th>
                    ...
                    if(!empty($row_duty['extra_chg']))
                    {
                       $html.='<tr>
                            ...
                            $othercharges+=$row_duty['extra_chg'];
                    }
					...
					if(!empty($othercharges))
					{
                            ...
                            <th colspan="2"><b>'.$othercharges.'</b></th>
                            </tr>';
					}
					if(!empty($row_invoice['tax']))
					{
						...
						while($row_taxrate=mysql_fetch_array($result_taxrate))
						{
                            ...
                            <tr>
                            <td colspan="4"><b>'.convert_number_to_words($row_invoice['grand_total']).' Only</b></td>
                            </tr>
                            <tr>
