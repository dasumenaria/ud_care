...
else if(!empty($ledger_type))
{
	...
	?>
       		<select name="ledger_name" class="span6 m-wrap chosen" onchange="fetch_invoice_no(this.value);">	
...
else if(!empty($srno))
{
	...
	<td><input type="text" class="m-wrap small" name="amount<?php echo $srno; ?>" id="amount<?php echo $srno; ?>" onkeyup="show_total();" autocomplete="off"/></td> 
    </tr>
    <?php
}
